...
if ($result) {
    ...
    while( $row = $result->fetch() ) {
		...
		"link"  => "P-detailsWin,width=1100,height=500,toolbar=no,scrollbars=yes, resizable=no-modules/charts_details.php?modules=xtptarea"."&areaid=".$row["AREAID"]."&giid=&bulan=".$bulan."&tahun=".$tahun."&kodefgtm=&lama=1&relay="
		));
        array_push($data_temporer, array("value" => $row["TEMPORER"],
		"link"  => "P-detailsWin,width=1100,height=500,toolbar=no,scrollbars=yes, resizable=no-modules/charts_details.php?modules=xtptarea"."&areaid=".$row["AREAID"]."&giid=&bulan=".$bulan."&tahun=".$tahun."&kodefgtm=&lama=2&relay="
		));
    }
