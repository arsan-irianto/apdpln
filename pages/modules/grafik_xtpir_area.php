...
$sp = "{:retval = CALL PCDR_RELAY_AREA_TRIP (@BULAN=:bulan,@TAHUN=:tahun)}";
...
if ($result) {
    ...
    $arrData = array(
        "chart" => array(
            "caption" => "Kali Trip Per Indikasi Relay by Area Dist",
            "bgColor" => "#ffffff",
            "borderAlpha"=> "20",
            "canvasBorderAlpha"=> "0",
    ...
    while( $row = $result->fetch() ) {
        ...
        array_push($data_ocr, array("value" => $row["OCR"],
				"link"  => "P-detailsWin,width=1100,height=500,toolbar=no,scrollbars=yes, resizable=no-modules/charts_details.php?modules=xtpirarea"."&areaid=".$row["AREAID"]."&giid=&bulan=".$bulan."&tahun=".$tahun."&relay=OCR&kodefgtm=&lama="
		));
        array_push($data_gfr, array("value" => $row["GFR"],
				"link"  => "P-detailsWin,width=1100,height=500,toolbar=no,scrollbars=yes, resizable=no-modules/charts_details.php?modules=xtpirarea"."&areaid=".$row["AREAID"]."&giid=&bulan=".$bulan."&tahun=".$tahun."&relay=GFR&kodefgtm=&lama="
		));
        array_push($data_ufr, array("value" => $row["UFR"],
				"link"  => "P-detailsWin,width=1100,height=500,toolbar=no,scrollbars=yes, resizable=no-modules/charts_details.php?modules=xtpirarea"."&areaid=".$row["AREAID"]."&giid=&bulan=".$bulan."&tahun=".$tahun."&relay=UFR&kodefgtm=&lama="
		));
        array_push($data_ocr_gfr, array("value" => $row["OCR-GFR"],
				"link"  => "P-detailsWin,width=1100,height=500,toolbar=no,scrollbars=yes, resizable=no-modules/charts_details.php?modules=xtpirarea"."&areaid=".$row["AREAID"]."&giid=&bulan=".$bulan."&tahun=".$tahun."&relay=OCR-GFR&kodefgtm=&lama="
		));
        array_push($data_ufr_gfr, array("value" => $row["UFR-GFR"],
				"link"  => "P-detailsWin,width=1100,height=500,toolbar=no,scrollbars=yes, resizable=no-modules/charts_details.php?modules=xtpirarea"."&areaid=".$row["AREAID"]."&giid=&bulan=".$bulan."&tahun=".$tahun."&relay=UFR-GFR&kodefgtm=&lama="
		));
    }
    // Plotting Categories
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <form name="period" id="period" method="get" >
                                        <input type="hidden" name="modules" id="modules" value="xtpir_area">
                                        <?php
