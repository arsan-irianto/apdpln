...
class PHPJasperXML {
    ...
    $this->cndriver=$cndriver;
        if($cndriver=="mysql") {
            ...
            if(!$this->con) {
                //$this->myconn = odbc_connect($db_or_dsn_name,$db_user,$db_pass); // Kode asli
				//Modifikasi
				/*
				$user = 'apdpln';
				$pass = 'apdpln';
				$server = 'HISTORICAL\MSSQLAPDPLN';
				$database = 'apdpln';*/

				// No changes needed from now on
				$connection_string = "DRIVER={SQL Server};SERVER=$db_host;DATABASE=$db_or_dsn_name";
				//$conn = odbc_connect($connection_string,$user,$pass);
				$this->myconn = odbc_connect($connection_string,$db_user,$db_pass);
