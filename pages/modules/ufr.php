...
<script src="modules/ufr.js" type="text/javascript"></script>
<style>
...
<div class="row">
    <div class="col-md-12">
        <div class="box box-warning">
            <div class="box-header">
                <div class="row">
                    <div class="col-md-4"><h3 class="box-title">Data UFR</h3></div>
    ...
    <div class="box-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover" id="tufr" style="width: 100%;font-size: 0.9em;">
                <thead>
                <tr>
                    <th rowspan="2">No</th>
