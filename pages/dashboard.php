...
//$strQuery = "SELECT NAMA_UNIT, GANGGUAN_PER_TOTAL FROM REKAP_FGTM";
...
if ($result) {
    ...
    $arrData = array(
        "chart" => array(
            "caption" => "Jumlah Gangguan Penyulang > 5 menit Per Area Unit",
            "bgColor" => "#ffffff",
            "borderAlpha"=> "20",
            "canvasBorderAlpha"=> "0",
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <form name="period" id="period" method="get" >
                                            <input type="hidden" name="modules" id="modules" value="dashboard">
                                        <?php
